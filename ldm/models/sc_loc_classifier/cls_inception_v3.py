...
from ldm.models.model_util import load_pretrained
from ldm.models.sc_loc_classifier.inception_v3 import inception_v3

DATA_ROOT = os.environ.get("MYDATA", "/scratch/users/xikunz2")
...
def get_model(args, **kwargs):
  net = cls_inception_v3_cbam(args)
...
def load_model(device):
  args = types.SimpleNamespace(image_size=[128, 128], model_fpath=f"{DATA_ROOT}/HPA_SingleCellClassification/team1_bestfitting/models/d0507_cellv4b_3labels_cls_inception_v3_cbam_i128x128_aug2_5folds/fold0/12.00_ema.pth", device=device, can_print=True, scheduler=None, loss=None, pretrained=False, in_channels=4, num_classes=19)
